...
func (x *POKTHTTPRequest) GetHeader() map[string]string {
	if x != nil {
		return x.Header
	}
	return nil
...
func (x *POKTHTTPResponse) GetHeader() map[string]string {
	if x != nil {
		return x.Header
	}
	return nil
...
var file_proto_types_http_proto_rawDesc = []byte{
	...
	0x70, 0x65, 0x73, 0x22, 0xcf, 0x01, 0x0a, 0x0f, 0x50, 0x4f, 0x4b, 0x54, 0x48, 0x54, 0x54, 0x50,
	...
	0x28, 0x0c, 0x52, 0x06, 0x62, 0x6f, 0x64, 0x79, 0x42, 0x7a, 0x1a, 0x39, 0x0a, 0x0b, 0x48, 0x65,
	0x61, 0x64, 0x65, 0x72, 0x45, 0x6e, 0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xc8, 0x01, 0x0a, 0x10, 0x50, 0x4f, 0x4b, 0x54, 0x48, 0x54,
	...
	0x0a, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x3f, 0x0a, 0x06, 0x68,
	0x65, 0x61, 0x64, 0x65, 0x72, 0x18, 0x02, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x27, 0x2e, 0x73, 0x64,
	0x6b, 0x2e, 0x74, 0x79, 0x70, 0x65, 0x73, 0x2e, 0x50, 0x4f, 0x4b, 0x54, 0x48, 0x54, 0x54, 0x50,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x2e, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x45,
	0x6e, 0x74, 0x72, 0x79, 0x52, 0x06, 0x68, 0x65, 0x61, 0x64, 0x65, 0x72, 0x12, 0x17, 0x0a, 0x07,
	0x62, 0x6f, 0x64, 0x79, 0x5f, 0x62, 0x7a, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x06, 0x62,
	0x6f, 0x64, 0x79, 0x42, 0x7a, 0x1a, 0x39, 0x0a, 0x0b, 0x48, 0x65, 0x61, 0x64, 0x65, 0x72, 0x45,
	...
	0x6f, 0x6b, 0x74, 0x2d, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2f, 0x73, 0x68, 0x61, 0x6e,
	0x6e, 0x6f, 0x6e, 0x2d, 0x73, 0x64, 0x6b, 0x2f, 0x74, 0x79, 0x70, 0x65, 0x73, 0x62, 0x06, 0x70,
...
var file_proto_types_http_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_proto_types_http_proto_goTypes = []interface{}{
	(*POKTHTTPRequest)(nil),  // 0: sdk.types.POKTHTTPRequest
	(*POKTHTTPResponse)(nil), // 1: sdk.types.POKTHTTPResponse
	nil,                      // 2: sdk.types.POKTHTTPRequest.HeaderEntry
	nil,                      // 3: sdk.types.POKTHTTPResponse.HeaderEntry
}
var file_proto_types_http_proto_depIdxs = []int32{
	2, // 0: sdk.types.POKTHTTPRequest.header:type_name -> sdk.types.POKTHTTPRequest.HeaderEntry
	3, // 1: sdk.types.POKTHTTPResponse.header:type_name -> sdk.types.POKTHTTPResponse.HeaderEntry
...
func file_proto_types_http_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_proto_types_http_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*POKTHTTPRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_proto_types_http_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*POKTHTTPResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
